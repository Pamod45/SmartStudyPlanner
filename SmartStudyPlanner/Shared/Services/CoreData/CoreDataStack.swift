...
// Core Data entity classes used by the programmatic model below.
// The project builds its Core Data schema in code instead of using an .xcdatamodeld file.
@objc(CDUserProfile)
...
public class CoreDataStack {
    ...
    // If the generated model changes in an incompatible way, the local cache can be reset and rebuilt from Firebase.
    ...
    // Builds the whole Core Data model manually, including transformable array fields used by resources, sessions, and deadlines.
    public lazy var persistentContainer: NSPersistentContainer = {
        ...
        // Arrays are stored as secure transformable attributes because Core Data has no native [String] scalar type.
