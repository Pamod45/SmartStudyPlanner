...
// Lightweight NaturalLanguage helpers for extracting keywords, sentences, chunks, and summary-worthy sentences.
// StudyContentOrchestrator exposes this through quickSummary; the main AI generation path uses the LLM backends.
struct NLTextAnalyzer {

    // Pulls named entities first, then important nouns/verbs, while keeping the result de-duplicated.
    ...
    // Scores sentences by how many extracted keywords they contain, then returns the highest scoring lines.
