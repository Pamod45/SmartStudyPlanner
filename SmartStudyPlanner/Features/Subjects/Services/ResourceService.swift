...
// Manages subject resources in Firestore and Core Data.
// Resource changes also update the parent subject's resource count.
...
class ResourceService {
    ...
    // Saves a new resource and increments the subject's resource count in the same Firestore batch.
    ...
    // Fetches all resources for a subject, caches them, and recalculates the local subject count.
    ...
    // Updates the cached subject count from actual resource documents.
    ...
    // Updates resource metadata/content in Firestore and refreshes the local cached copy.
    ...
    // Deletes a resource and decrements the parent subject's resource count.
